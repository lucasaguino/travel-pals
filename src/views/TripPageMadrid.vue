  ...
  <div>
    <header class="h-[15rem] relative text-white flex w-100 justify-around items-center p-4 bg-cover bg-center"  style="background-image: url(https://upload.wikimedia.org/wikipedia/commons/thumb/a/a7/Prague_%286365119737%29.jpg/800px-Prague_%286365119737%29.jpg);">
      ...
      <div class="z-20 flex items-center">
        ...
        <div>
          <h3 class="text-4xl">Madrid</h3>
          <h5 class="mt-2 text-xl">04/05/2024 - 05/05/2024</h5>
        </div>
    ...
    <Card class="!p-0 !m-5 poi-card rounded-md">
      <template #content>
        <div  class="flex flex-row ">
          ...
          <h3 class="text-lg mr-3 !font-bold">Retiro Park</h3>
          <Divider />
          <p class="!mt-1 !mb-4">Take a photo and show it to the rest of the world!</p>

        </div>

        <div class="basis-1/3 h-[12rem] bg-cover bg-center rounded-r-md" style="background-image: url(src/assets/photos/6/Madrid/retiro_park.jpg)"></div>
    ...
    <Card class="!p-0 !m-5 poi-card rounded-md">
      <template #content>
        <div  class="flex flex-row ">
          ...
          <div class="basis-2/3  !m-5">
          <h3 class="text-lg mr-3 !font-bold">Plaza Mayor</h3>
          <Divider />
          <p class="!mt-1 !mb-4">Take a photo and show it to the rest of the world!</p>
          ...
          <span class="!font-bold">Sara, Juan</span>
        </div>
        </div>

        <div class="basis-1/3 h-[12rem] bg-cover bg-center rounded-r-md" style="background-image: url(src/assets/photos/6/Madrid/plaza_mayor.jpg)"></div>
    ...
    <Card class="!p-0 !m-5 poi-card rounded-md">
      <template #content>
        <div  class="flex flex-row ">
          ...
          <div class="basis-2/3  !m-5">
          <h3 class="text-lg mr-3 !font-bold">Royal Palace of Madrid</h3>
          <Divider />
          <p class="!mt-1 !mb-4">Take a photo and show it to the rest of the world!</p>
        ...
        <div class="basis-1/3 h-[12rem] bg-cover bg-center rounded-r-md" style="background-image: url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ9KuWFfxp_9PdSitcDCYvpHGjL3x-7FKr-92YgSZhCgA&s)"></div>
